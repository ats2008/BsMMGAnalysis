...
config.General.requestName = 'ntuples_defaultReco_Run2MVABranches_QCD-Pt15to30'
...
config.Data.outputDatasetTag = 'ntuples_defaultReco_Run2MVABranches_QCD-Pt15to30'
