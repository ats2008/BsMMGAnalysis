...
config.General.requestName = 'ntuples_defaultReco_Run2MVABranches_QCD-Pt80to120'
...
config.Data.outputDatasetTag = 'ntuples_defaultReco_Run2MVABranches_QCD-Pt80to120'
