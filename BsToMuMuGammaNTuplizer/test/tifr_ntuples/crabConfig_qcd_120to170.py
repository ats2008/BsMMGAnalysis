...
config.General.requestName = 'ntuples_defaultReco_Run2MVABranches_QCD-Pt120to170'
...
config.Data.outputDatasetTag = 'ntuples_defaultReco_Run2MVABranches_QCD-Pt120to170'
