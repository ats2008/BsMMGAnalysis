...
config.General.requestName = 'ntuples_defaultReco_Run2MVABranches_QCD-Pt50to80'
...
config.Data.outputDatasetTag = 'ntuples_defaultReco_Run2MVABranches_QCD-Pt50to80'
