...
config.General.requestName = 'ntuples_defaultReco_Run2MVABranches_QCDEmEnriched_Pt170to300'
...
config.Data.outputDatasetTag = 'ntuples_defaultReco_Run2MVABranches_QCDEmEnriched_Pt170to300'
