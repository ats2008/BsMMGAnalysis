...
config.General.requestName = 'ntuples_defaultReco_Run2MVABranches_QCDEmEnriched_Pt30to50'
...
config.Data.outputDatasetTag = 'ntuples_defaultReco_Run2MVABranches_QCDEmEnriched_Pt30to50'
