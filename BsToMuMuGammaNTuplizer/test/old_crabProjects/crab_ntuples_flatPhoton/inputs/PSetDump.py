...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:/afs/cern.ch/work/r/rchudasa/private/bsmumu/Run2_analysis/CMSSW_10_6_20/src/mcProduction/AODSIM_pion.root')
)
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('flatPtPi0_ntuple.root')
)
