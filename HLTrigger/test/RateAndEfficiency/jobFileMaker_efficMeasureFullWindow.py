...
maskJPsi=False
destination='/grid_mnt/t3storage3/athachay/bs2mumug/hltDev/CMSSW_11_3_0/src/Analysis/HLTAnalyserPy/Run3HLTNtuplizer/efficencyANDrates/Run3MCFullWindow'
FNAME = "/grid_mnt/t3storage3/athachay/bs2mumug/hltDev/CMSSW_11_3_0/src/Analysis/HLTAnalyserPy/Run3HLTNtuplizer/Run314TevBsTommGHLTEfficiencyNtupleV3_0.root"
cfgTxt=pSetup.getConfigTemplateForMC();
parset=pSetup.getPSetForRateAndEffic()

baseOfCode="/grid_mnt/t3storage3/athachay/bs2mumug/hltDev/CMSSW_11_3_0/src/Analysis/HLTAnalyserPy/Run3HLTNtuplizer/"
...
cd "+pwd+"/@@DIRNAME \n\
cp "+baseOfCode+"*.h . \n\
cp "+baseOfCode+"rate_production.cc . \n\
cp "+baseOfCode+"rate_production.cc . \n\
cp "+baseOfCode+"HLTNtupleTreeV3* . \n\
