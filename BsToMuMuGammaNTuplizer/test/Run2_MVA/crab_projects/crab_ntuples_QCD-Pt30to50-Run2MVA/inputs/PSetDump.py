...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:/eos/cms/store/group/phys_heavyions/rchudasa/lowPT_photonReco/SinglePhotonFlatPt1To20_GENSIM_Run2018/crab_SinglePhotonFlatPt1To20_default_RecoAOD_Run2018/210504_050451/0000/AODSIM_3.root')
)
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('qcd_nonEmEnriched_ntuples.root')
)
...
process.p = cms.Path(process.Ntuples+process.egmPhotonIDSequence+process.ntupler)
